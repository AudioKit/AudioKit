//
//  AKTrackedAmplitudeAudioUnit.mm
//  AudioKit
//
...
#import "AKTrackedAmplitudeAudioUnit.h"
#import "AKTrackedAmplitudeDSPKernel.hpp"

#import <AVFoundation/AVFoundation.h>
#import "AKBufferedAudioBus.hpp"

@interface AKTrackedAmplitudeAudioUnit()
...
@implementation AKTrackedAmplitudeAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    AKTrackedAmplitudeDSPKernel _kernel;
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription
    ...
    __block AKTrackedAmplitudeDSPKernel *blockKernel = &_kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
     ...
     */
    __block AKTrackedAmplitudeDSPKernel *state = &_kernel;
