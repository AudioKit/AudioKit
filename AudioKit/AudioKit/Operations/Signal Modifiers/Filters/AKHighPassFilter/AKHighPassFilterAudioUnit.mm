...
#import "AKHighPassFilterAudioUnit.h"
#import "AKHighPassFilterDSPKernel.hpp"

#import <AVFoundation/AVFoundation.h>
#import "AKBufferedAudioBus.hpp"

@interface AKHighPassFilterAudioUnit()
...
@implementation AKHighPassFilterAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    AKHighPassFilterDSPKernel _kernel;
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription
    ...
    __block AKHighPassFilterDSPKernel *blockKernel = &_kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
     ...
     */
    __block AKHighPassFilterDSPKernel *state = &_kernel;
