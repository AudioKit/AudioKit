...
public:
  ...
  //! Take a channel of the StkFrames object as inputs to the function and
  //! replace with corresponding outputs.
  /*!
  ...
  */
  ...
  //! Take a channel of the \c iFrames object as inputs to the function and
  //! write outputs to the \c oFrames object.
  /*!
...
inline StkFrames &Cubic ::tick(StkFrames &iFrames, StkFrames &oFrames,
