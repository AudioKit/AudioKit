...
public:
  //! Class constructor, specifying an arbitrary number of strings (default =
  //! 6).
...
inline StkFrames &Guitar ::tick(StkFrames &iFrames, StkFrames &oFrames,
