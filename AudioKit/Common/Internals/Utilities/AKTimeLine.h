...
/**
 ...
 of the timeline.
 */
typedef void (*AKTimeLineCallback)(AudioTimeStamp *timeStamp, UInt32 inNumberFrames, void *refCon);
...
/**
 ...
 @param sampleRate Should match the sampleRate from the audio context that AKTimeLineRender 
 will be called from.
...
/**
 ...
 @param audioTime A timestamp representing a time in the audio render context.
 */
void AKTimelineSetState(AKTimeline *timeline, SInt64 sampleTime, UInt32 loopStart, UInt32 loopEnd, AudioTimeStamp audioTime);
