...
open class AKMIDICallbackInstrument: AKMIDIInstrument {
    ...
    ///   - channel:    MIDI Channel
    ///
    override open func stop(noteNumber: MIDINoteNumber, channel: MIDIChannel, offset: UInt32 = 0) {
    ...
    override open func receivedMIDIAfterTouch(_ pressure: MIDIByte, channel: MIDIChannel, offset: UInt32 = 0) {
        triggerCallbacks(AKMIDIStatus(type: .channelAftertouch, channel: channel), data1: pressure, data2: 0)
    }

    override open func receivedMIDIPitchWheel(_ pitchWheelValue: MIDIWord, channel: MIDIChannel, offset: UInt32 = 0) {
