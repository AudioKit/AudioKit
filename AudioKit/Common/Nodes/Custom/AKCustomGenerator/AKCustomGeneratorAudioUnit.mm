...
#import "AKCustomGeneratorAudioUnit.h"
#import "AKCustomGeneratorDSPKernel.hpp"

#import <AVFoundation/AVFoundation.h>
#import "AKBufferedAudioBus.hpp"

@interface AKCustomGeneratorAudioUnit()
...
@implementation AKCustomGeneratorAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    AKCustomGeneratorDSPKernel _kernel;
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription
    ...
    __block AKCustomGeneratorDSPKernel *blockKernel = &_kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
     ...
     */
    __block AKCustomGeneratorDSPKernel *state = &_kernel;
