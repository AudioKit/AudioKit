...
@interface AKHighPassButterworthFilterAudioUnit()
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription
    ...
    __block AKHighPassButterworthFilterDSPKernel *filterKernel = &_kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
     ...
     */
    __block AKHighPassButterworthFilterDSPKernel *state = &_kernel;
