...
@interface AKHighShelfParametricEqualizerFilterAudioUnit()
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription
    ...
    __block AKHighShelfParametricEqualizerFilterDSPKernel *equalizerKernel = &_kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
     ...
     */
    __block AKHighShelfParametricEqualizerFilterDSPKernel *state = &_kernel;
