...
@interface AKLowPassButterworthFilterAudioUnit()
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription
    ...
    __block AKLowPassButterworthFilterDSPKernel *blockKernel = &_kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
     ...
     */
    __block AKLowPassButterworthFilterDSPKernel *state = &_kernel;
