...
@interface AKPhaseDistortionOscillatorAudioUnit()
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription
    ...
    __block AKPhaseDistortionOscillatorDSPKernel *oscillatorKernel = &_kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
     ...
     */
    __block AKPhaseDistortionOscillatorDSPKernel *state = &_kernel;
