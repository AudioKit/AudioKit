...
/// STK TubularBells
///
public class AKTubularBells: AKNode, AKToggleable, AKComponent, AKAutomatable {
    ...
    public static let frequencyDef = AKNodeParameterDef(
        ...
        name: "Frequency (Hz)",
        address: akGetParameterAddress("AKTubularBellsParameterFrequency"),
        range: 0.0 ... 20_000.0,
        unit: .hertz,
        flags: .default)
    ...
    public static let amplitudeDef = AKNodeParameterDef(
        ...
        name: "Amplitude",
        address: akGetParameterAddress("AKTubularBellsParameterAmplitude"),
        range: 0...10,
        unit: .generic,
        flags: .default)
    ...
    public class InternalAU: AKAudioUnitBase {
        ...
        public override func getParameterDefs() -> [AKNodeParameterDef] {
            [AKTubularBells.frequencyDef,
             AKTubularBells.amplitudeDef]
        }
