...
public class AKSampler: AKNode {
    ...
    */
    ...
    static public func generateAUPresetOpenInstrument()->String{
        var templateStr:String = ""
        templateStr = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
        templateStr.appendContentsOf("<!DOCTYPE plist PUBLIC \"-//Apple//DTD PLIST 1.0//EN\" \"http://www.apple.com/DTDs/PropertyList-1.0.dtd\">\n")
        templateStr.appendContentsOf("<plist version=\"1.0\">\n")
    ...
    static public func generateAUPresetOpenLayers()->String{
        var templateStr:String = ""
        templateStr.appendContentsOf("            <key>Layers</key>\n")
        templateStr.appendContentsOf("            <array>\n")
        return templateStr
    }
    static public func generateAUPresetOpenLayer()->String{
            var templateStr = ""
            templateStr.appendContentsOf("                <dict>\n")
            templateStr.appendContentsOf("                    <key>Amplifier</key>\n")
            templateStr.appendContentsOf("                    <dict>\n")
    ...
    static public func generateAUPresetOpenConnections()->String{
        var templateStr = ""
        templateStr.appendContentsOf("                    <key>Connections</key>\n")
        templateStr.appendContentsOf("                    <array>\n")
        return templateStr
    }
    static public func generateAUPresetConnectionDict
        (id:Int, source:Int, destination:Int, scale:Int, transform:Int = 1, invert:Bool = false)
        ->String{
        var templateStr = ""
        templateStr.appendContentsOf("                        <dict>\n")
        templateStr.appendContentsOf("                            <key>ID</key>\n")
    ...
    static public func generateAUPresetCloseConnections()->String{
        var templateStr = ""
        templateStr.appendContentsOf("                    </array>\n")
        return templateStr
    }
    static public func generateAUPresetCloseLayer()->String{
        var templateStr = ""
        templateStr.appendContentsOf("                </dict>\n")
        return templateStr
    }
    static public func generateAUPresetCloseLayers()->String{
        var templateStr:String = ""
        templateStr.appendContentsOf("            </array>\n")
        return templateStr
    }
