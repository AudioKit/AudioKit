...
public class AKCustomModifier: AKOperation {

    // MARK: - Properties

    private var internalAU: AKCustomModifierAudioUnit?
    private var token: AUParameterObserverToken?

    // MARK: - Initializers

    /** Initialize this reverb operation */
    public init(_ input: AKOperation, sporth: String) {
        super.init()
        ...
        AUAudioUnit.registerSubclass(
            AKCustomModifierAudioUnit.self,
            asComponentDescription: description,
            name: "Local AKCustomModifier",
            version: UInt32.max)
        ...
        AVAudioUnit.instantiateWithComponentDescription(description, options: []) {
            ...
            self.internalAU = avAudioUnitEffect.AUAudioUnit as? AKCustomModifierAudioUnit
