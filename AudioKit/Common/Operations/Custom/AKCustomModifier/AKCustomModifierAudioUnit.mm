...
#import "AKCustomModifierAudioUnit.h"
#import "AKCustomModifierDSPKernel.hpp"

#import <AVFoundation/AVFoundation.h>
#import "AKBufferedAudioBus.hpp"

@interface AKCustomModifierAudioUnit()
...
@implementation AKCustomModifierAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    AKCustomModifierDSPKernel _kernel;
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription
    ...
    __block AKCustomModifierDSPKernel *blockKernel = &_kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
     ...
     */
    __block AKCustomModifierDSPKernel *state = &_kernel;
