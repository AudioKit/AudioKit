...
extension AKOperation {
    ...
    public static func jitter(
        ...
        minimumFrequency: AKOperation = 0.5.ak,
        maximumFrequency: AKOperation = 4.ak
        ) -> AKOperation {
...
public func jitter(
    ...
    maximumFrequency: AKOperation = 4.ak
        ...
        return AKOperation.jitter(amplitude: amplitude, minimumFrequency: minimumFrequency, maximumFrequency: maximumFrequency)
}