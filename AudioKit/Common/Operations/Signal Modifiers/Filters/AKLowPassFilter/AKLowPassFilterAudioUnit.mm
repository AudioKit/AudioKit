...
#import "AKLowPassFilterAudioUnit.h"
#import "AKLowPassFilterDSPKernel.hpp"

#import <AVFoundation/AVFoundation.h>
#import "AKBufferedAudioBus.hpp"

@interface AKLowPassFilterAudioUnit()
...
@implementation AKLowPassFilterAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    AKLowPassFilterDSPKernel _kernel;
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription
    ...
    __block AKLowPassFilterDSPKernel *blockKernel = &_kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
     ...
     */
    __block AKLowPassFilterDSPKernel *state = &_kernel;
