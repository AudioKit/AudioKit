...
extension AKP {
    ...
    /** costelloReverb: 8 delay line stereo FDN reverb - 8 delay line stereo FDN reverb, with feedback matrix based upon physical
 ...
 impedance.
     ...
     */
    public static func costelloReverb(
        input: AKParameter,
        feedback: AKParameter = 0.6.ak,
        cutoffFrequency: AKParameter = 4000.ak
        ) -> AKStereoParameter {
            return AKStereoParameter("\(input)\(feedback)\(cutoffFrequency)revsc")
    }
}
