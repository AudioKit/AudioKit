...
Iir ::Iir(std::vector<StkFloat> &bCoefficients,
...
void Iir ::setCoefficients(std::vector<StkFloat> &bCoefficients,
                           std::vector<StkFloat> &aCoefficients,
                           bool clearState) {
...
void Iir ::setDenominator(std::vector<StkFloat> &aCoefficients,
                          bool clearState) {
  // Check the argument.
