...
public:
  ...
  void setCoefficients(StkFloat b0, StkFloat a1, StkFloat a2,
...
inline StkFloat TwoPole ::tick(StkFloat input) {
  ...
  lastFrame_[0] =
      b_[0] * inputs_[0] - a_[1] * outputs_[1] - a_[2] * outputs_[2];
...
inline StkFrames &TwoPole ::tick(StkFrames &iFrames, StkFrames &oFrames,
