...
let stairwell = bundle.URLForResource("Impulse Responses/stairwell")!
let dish = bundle.URLForResource("Impulse Responses/dish")!
...
XCPlaygroundPage.currentPage.liveV
