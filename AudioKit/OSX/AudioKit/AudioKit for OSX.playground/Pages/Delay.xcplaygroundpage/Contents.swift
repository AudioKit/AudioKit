...
class PlaygroundView: AKPlaygroundView {
    ...
    override func setup() {
        ...
        addSlider("setTime:", value: delay.time, minimum: 0, maximum: 1)
        
        feedbackLabel = addLabel("Feedback: \(delay.feedback)")
        addSlider("setFeedback:", value: delay.feedback)
        
        lowPassCutoffFrequencyLabel = addLabel("Low Pass Cutoff Frequency: \(delay.lowPassCutoff)")
        addSlider("setLowPassCutoffFrequency:", value: delay.lowPassCutoff, minimum: 0, maximum: 22050)
        
        dryWetMixLabel = addLabel("Mix: \(delay.dryWetMix)")
        addSlider("setDryWetMix:", value: delay.dryWetMix)
    }
