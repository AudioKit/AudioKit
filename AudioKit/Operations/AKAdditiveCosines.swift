...
@objc class AKAdditiveCosines : AKParameter {
    ...
    */
    convenience init(
        harmonicsCount       nharm: AKParameter,
        firstHarmonicIndex   lharm: AKParameter,
        partialMultiplier    mul:   AKParameter,
        fundamentalFrequency freq:  AKParameter,
        amplitude            amp:   AKParameter,
        phase                iphs:  AKParameter)
    {
        self.init()

        harmonicsCount       = nharm
        firstHarmonicIndex   = lharm
        partialMultiplier    = mul
