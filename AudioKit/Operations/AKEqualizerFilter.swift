...
@objc class AKEqualizerFilter : AKParameter {
    ...
    */
    ...
    override func compute() -> Float {
        sp_eqfil_compute(AKManager.sharedManager.data, eqfil, &(input.value), &value);
