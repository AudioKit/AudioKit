...
@objc class AKJitter : AKParameter {
    ...
    */
    convenience init(
        ...
        minimumFrequency cpsMin: AKParameter,
        maximumFrequency cpsMax: AKParameter)
    {
        self.init()

        amplitude        = amp
        minimumFrequency = cpsMin
        maximumFrequency = cpsMax
    ...
    override func compute() -> Float {
        sp_jitter_compute(AKManager.sharedManager.data, jitter, nil, &value);
