...
//  AudioKit
//
//  Autogenerated by scripts by Aurelius Prochazka on 9/7/15.
...
@objc class AKMoogLadder : AKParameter {
    ...
    */
    ...
    override func compute() -> Float {
        sp_moogladder_compute(AKManager.sharedManager.data, moogladder, &(input.value), &value);
