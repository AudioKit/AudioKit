...
@objc class AKReverb : AKParameter {
    ...
    var feedback: AKParameter = akp(0.6) {
        didSet { feedback.bind(&revsc.memory.feedback) }
    }

    /** Low-pass cutoff frequency. [Default Value: 4000] */
    var lpfreq: AKParameter = akp(4000) {
        didSet { lpfreq.bind(&revsc.memory.lpfreq) }
    }
    ...
    -parameter lpfreq Low-pass cutoff frequency. [Default Value: 4000]
    */
    convenience init(
        input    sourceInput:   AKParameter,
        feedback feedbackInput: AKParameter,
        lpfreq   lpfreqInput:   AKParameter)
    {
    ...
    internal func bindAll() {
        ...
        lpfreq  .bind(&revsc.memory.lpfreq)
    }
