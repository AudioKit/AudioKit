...
@interface AKLineSegmentTable : AKFunctionTable

/// Instantiates an straight line segment table.
...
/// Instantiates an straight line segment table using breakpoints.
/// @param tableSize    Number of points in the table. Must be a power of 2 or power-of-2 plus 1.
