...
@interface AKADSRAudioEnvelope : AKAudio
/// Instantiates the adsr audio envelope with all values
...
/// Instantiates the adsr audio envelope with default values
- (instancetype)init;
