...
@interface AKADSRControlEnvelope : AKControl
/// Instantiates the adsr control envelope with all values
...
/// Instantiates the adsr control envelope with default values
- (instancetype)init;
