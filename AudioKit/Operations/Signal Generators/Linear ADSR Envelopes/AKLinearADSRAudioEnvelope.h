...
@interface AKLinearADSRAudioEnvelope : AKAudio
/// Instantiates the linear adsr audio envelope with all values
...
/// Instantiates the linear adsr audio envelope with default values
- (instancetype)init;
