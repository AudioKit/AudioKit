...
/** Peaking Parametric Equalizer

This is an implementation of Zoelzer's parametric equalizer filter.
*/
@objc class AKPeakingParametricEqualizerFilter : AKParameter {
    ...
    /** Center frequency. [Default Value: 1000] */
    ...
    /** EQ mode. 0 = peak, 1 = low shelving, 2 = high shelving [Default Value: 0] */
    ...
    */
    ...
    - parameter input: Input audio signal. 
    - parameter centerFrequency: Center frequency. [Default Value: 1000]
    ...
    */
    convenience init(
        ...
        centerFrequency fcInput:     AKParameter,
        gain            vInput:      AKParameter,
        q               qInput:      AKParameter)
    {
        self.init(input: sourceInput)
        centerFrequency = fcInput
        gain            = vInput
        q               = qInput
