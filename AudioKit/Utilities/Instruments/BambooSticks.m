...
- (instancetype)init
{
    self = [super init];
    if (self) {
        _count = [self createPropertyWithValue:2 minimum:1 maximum:400];
        _count.isContinuous = NO;
        _mainResonantFrequency = [self createPropertyWithValue:2800 minimum:1 maximum:400];
        _mainResonantFrequency.isContinuous = NO;
        _firstResonantFrequency = [self createPropertyWithValue:2240 minimum:1 maximum:400];
        _firstResonantFrequency.isContinuous = NO;
        _secondResonantFrequency = [self createPropertyWithValue:3360 minimum:1 maximum:400];
