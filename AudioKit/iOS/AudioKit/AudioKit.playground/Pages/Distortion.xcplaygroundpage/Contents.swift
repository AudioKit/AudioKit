...
class PlaygroundView: AKPlaygroundView {
    ...
    override func setup() {
        ...
        addSlider("setDelay:", value: distortion.delay, minimum: 0.1, maximum: 500)
        
        decayLabel = addLabel("Decay: \(distortion.decay) Rate")
        addSlider("setDecay:", value: distortion.decay, minimum: 0.1, maximum: 50)
        
        delayMixLabel = addLabel("Delay Mix: \(distortion.delayMix)")
        addSlider("setDelayMix:", value: distortion.delayMix)
        
        linearTermLabel = addLabel("Linear Term: \(distortion.linearTerm)")
        addSlider("setLinearTerm:", value: distortion.linearTerm)
        
        squaredTermLabel = addLabel("Squared Term: \(distortion.squaredTerm)")
        addSlider("setSquaredTerm:", value: distortion.squaredTerm)
        
        cubicTermLabel = addLabel("Cubic Term: \(distortion.cubicTerm)")
        addSlider("setCubicTerm:", value: distortion.cubicTerm)
        
        polynomialMixLabel = addLabel("Polynomial Mix: \(distortion.polynomialMix)")
        addSlider("setPolynomialMix:", value: distortion.polynomialMix)
        
        softClipGainLabel = addLabel("Soft Clip Gain: \(distortion.softClipGain) dB")
        addSlider("setSoftClipGain:", value: distortion.softClipGain, minimum: -80, maximum: 20)
        
        finalMixLabel = addLabel("Final Mix: \(distortion.finalMix)")
        addSlider("setFinalMix:", value: distortion.finalMix)
