...
class PlaygroundView: AKPlaygroundView {
    ...
    func printCode() {
        ...
        print("    threshold = \(String(format: "%0.3f", effect.threshold))")
        print("    headRoom = \(String(format: "%0.3f", effect.headRoom))")
        print("    expansionRatio = \(String(format: "%0.3f", effect.expansionRatio))")
        print("    expansionThreshold = \(String(format: "%0.3f", effect.expansionThreshold))")
        print("    attackTime = \(String(format: "%0.3f", effect.attackTime))")
        print("    releaseTime = \(String(format: "%0.3f", effect.releaseTime))")
        print("    masterGain = \(String(format: "%0.3f", effect.masterGain))")
        print("}\n")
    }
