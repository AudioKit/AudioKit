...
class PlaygroundView: AKPlaygroundView, KeyboardDelegate {
    ...
    override func setup() {
        ...
        addSlider(#selector(self.setRampTime(_:)), value: currentRampTime, minimum: 0, maximum: 0.1)
        
        let keyboard = KeyboardView(width: playgroundWidth, height: 100, lowestKey: 24, totalKeys: 64)
