...
//: ### ability to use voltage control to determine the cutoff frequency of
//: ### the filter. As we're dealing with a software implementation, and
//: ### not an analog synthesizer, we don't have to worry about dealing with
//: ### voltage control directly. However, by using this node, you can emulate
//: ### some of the sounds of classic analog synthesizers in your app.
import XCPlayground
import AudioKit
