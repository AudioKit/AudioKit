...
//: ### are taken from a delay buffer at different points, and the taps are
//: ### then summed with the original. Multi-tap delays are great for creating
...
//: ### In AudioKit, you can create a multitap easily through creating
//: ### a function that mixes together several delays and gains.
