...
-(id)initWithOrchestra:(OCSOrchestra *)newOrchestra
{
    ...
    if (self) {
        ...
        OCSParamArray * amplitudeBreakpoints = [OCSParamArray paramArrayFromParams:
            [OCSParamConstant paramWithFormat:[OCSParamConstant paramWithFormat:@"%@ * 0.6", duration]], [OCSParamConstant paramWithInt:6000], nil];

        OCSLineSegmentWithRelease * amplitude = [[OCSLineSegmentWithRelease alloc] initWithFirstSegmentStartValue:[OCSParamConstant paramWithFloat:0.00001f]
                      FirstSegmentDuration:[OCSParamConstant paramWithFormat:@"%@ * 0.1", duration]FirstSegementTargetValue:[OCSParamConstant paramWithInt:3000] 
                        SegmentArray:amplitudeBreakpoints 
                            ReleaseDuration:[OCSParamConstant paramWithFormat:@"%@ 0.1", duration] FinalValue:[OCSParamConstant paramWithInt:0] 
                                                                                                        isControl:YES];
