...
public class AKConverterDev: NSObject {
    /**
     AKConverterDevCallback is the callback format for start()
     -Parameter: error This will contain one parameter of type Error which is nil if the conversion was successful.
     */
    public typealias AKConverterDevCallback = (_ error: Error?) -> Void
     ...
     */
    public func start(completionHandler: AKConverterDevCallback? = nil) {
    ...
    private func convertAsset(completionHandler: AKConverterDevCallback? = nil) {
        guard let inputURL = self.inputURL else {
            completionHandler?(createError(message: "Input file can't be nil."))
            return
        }
    ...
    private func convertCompressed(completionHandler: AKConverterDevCallback? = nil) {
        guard let inputURL = self.inputURL else {
            completionHandler?(createError(message: "Input file can't be nil."))
            return
        }
    ...
    private func convertToPCM(completionHandler: AKConverterDevCallback? = nil) {
