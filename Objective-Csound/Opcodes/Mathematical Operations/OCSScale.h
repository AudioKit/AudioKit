...
@property (nonatomic, strong) OCSParamControl *input;
/// Minimum value of the resultant scale operation.
@property (nonatomic, strong) OCSParamControl *minimumOutput;
/// Maximum value of the resultant scale operation.
@property (nonatomic, strong) OCSParamControl *maximumOutput;
