...
class PlaygroundView: AKPlaygroundView {
    ...
    override func setup() {
        ...
        addSubview(AKPropertySlider(property: "Drums Pan", value: drums.pan, minimum: -1) { sliderValue in
        ...
        addSubview(AKPropertySlider(property: "Bass Pan", value: bass.pan, minimum: -1) { sliderValue in
        ...
        addSubview(AKPropertySlider(property: "Guitar Pan", value: guitar.pan, minimum: -1) { sliderValue in
        ...
        addSubview(AKPropertySlider(property: "Lead Pan", value: lead.pan, minimum: -1) { sliderValue in
