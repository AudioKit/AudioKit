...
let akAudioFile = try AKAudioFile(readFileName: "Samples/click.wav", baseDir: .resources)
...
do {
    let nonExistentFile = try AKAudioFile(readFileName: "nonExistent.wav", baseDir: .resources)
