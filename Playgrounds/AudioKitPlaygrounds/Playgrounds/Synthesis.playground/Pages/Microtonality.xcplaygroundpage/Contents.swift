...
delay.lowPassCutoff = 12048
delay.dryWetMix = 0.75
let delayBooster = AKBooster(delay)
delayBooster.gain = 1.5508

// REVERB
let reverb = AKCostelloReverb(delayBooster)
reverb.feedback = 0.75881618
reverb.cutoffFrequency = 2222+1000
let reverbBooster = AKBooster(reverb)
reverbBooster.gain = 0.7467
...
presetDictionary["MOS 0.2381 9 tones"] = {() -> Void in _ = tuningTable.momentOfSymmetry(generator: 0.238186, level: 6)}
presetDictionary["MOS 0.2641 7 tones"] = {() -> Void in _ = tuningTable.momentOfSymmetry(generator: 0.264100, level: 5)}
presetDictionary["Tetrany Major (1,5,9,15)"] = {() -> Void in _ = tuningTable.tetrany_major(1, 5, 9, 15)}
presetDictionary["Hexany (1,5,9,15)"] = {() -> Void in _ = tuningTable.hexany(1, 5, 9, 15)}
presetDictionary["Tetrany Minor (1,5,9,15)"] = {() -> Void in _ = tuningTable.tetrany_minor(1, 5, 9, 15)}
presetDictionary["Hexany (3,4.,7.,10.)"] = {() -> Void in _ = tuningTable.hexany(3, 4.051, 7.051, 10.051)}
presetDictionary["MOS 0.2926 7 tones"] = {() -> Void in _ = tuningTable.momentOfSymmetry(generator: 0.292626, level: 5, murchana: 3)}
presetDictionary["MOS 0.5833 7 tones"] = {() -> Void in _ = tuningTable.momentOfSymmetry(generator: 0.583333, level: 5)}
presetDictionary["MOS 0.5833 7 tones, Mode 2"] = {() -> Void in _ = tuningTable.momentOfSymmetry(generator: 0.583333, level: 5, murchana: 2)}
...
let sequencerPatterns:[String: [Int]] = ["Up Down":[0,1,2,3,4,5,6,7,8,7,6,5,4,3,2,1],"Arp 1":[1,0,2,1,3,2,4,3,5,4,6,5,7,6,4,5,3,4,2,3,1,2,0,1], "Arp 2":[0,2,1,3,2,4,3,5,4,6,5,7,6,8,7,9,8,6,7,5,6,4,5,3,4,2,3,1]]
...
class PlaygroundView: AKPlaygroundView {
    ...
    override func setup() {
        ...
        addSubview(AKPropertySlider(
            ...
            value: filter.cutoffFrequency, minimum: 1, maximum: 12000,
            color: AKColor.red
        ) { cutoffFrequency in
