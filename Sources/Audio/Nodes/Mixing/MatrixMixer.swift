...
public class MatrixMixer: Node {
    ...
    public var auAudioUnit: AUAudioUnit { unit }

    public let unit = instantiateAU(
    ...
    public init(_ inputs: [Node]) {
        self.inputs = inputs
        self.audioUnit = (unit as! AUAudioUnitV2Bridge).audioUnit
