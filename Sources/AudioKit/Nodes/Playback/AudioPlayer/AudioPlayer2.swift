...
/// Wrapper for AVAudioPlayerNode with extended features. The player exists in two interchangeable modes
...
public class AudioPlayer2: Node {
    ...
    /// Create an AudioPlayer2 with default properties and nothing pre-loaded
    public init() {
        super.init(avAudioNode: mixerNode)
    }

    /// Create an AudioPlayer2 from file, optionally choosing to buffer it
    ...
    /// Create an AudioPlayer2 from URL, optionally choosing to buffer it
    ...
    /// Create an AudioPlayer2 from an existing buffer
