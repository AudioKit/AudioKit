...
#endif
            data = (sporth_sine_d*)malloc(sizeof(sporth_sine_d));
...
#endif
            pos = (uint32_t*)malloc(sizeof(uint32_t));
...
#endif
            dur = (SPFLOAT*)malloc(sizeof(SPFLOAT));
...
#endif
            ampdb = (SPFLOAT*)malloc(sizeof(SPFLOAT));
            if(sporth_check_args(stack, "f") != SPORTH_OK) {
...
#endif
            sr = (SPFLOAT*)malloc(sizeof(SPFLOAT));
