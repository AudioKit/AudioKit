...
#endif
            fload = (sporth_fload_d*)malloc(sizeof(sporth_fload_d));
...
#endif
            fclose = (sporth_fclose_d*)malloc(sizeof(sporth_fclose_d));
...
#endif
            fexec = (sporth_fload_d*)malloc(sizeof(sporth_fload_d));
...
#endif
            fexec = (sporth_fload_d*)pd->last->ud;
            fexec->name = sporth_stack_pop_string(stack);
