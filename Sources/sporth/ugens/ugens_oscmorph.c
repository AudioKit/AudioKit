...
int sporth_oscmorph4(sporth_stack *stack, void *ud)
{
    ...
    switch(pd->mode) {
...
#endif
            oscmorph = (sporth_oscmorph*)malloc(sizeof(sporth_oscmorph));
            sp_oscmorph_create(&oscmorph->data);
            oscmorph->nft = 4;
            oscmorph->ft = (sp_ftbl **)malloc(sizeof(sp_ftbl *) * 4);
            oscmorph->ftname = (const char **)malloc(sizeof(char *) * 4);
        ...
        case PLUMBER_INIT:
            ...
            oscmorph = (sporth_oscmorph*)pd->last->ud;
            get_strings(stack, oscmorph);
...
int sporth_oscmorph2(sporth_stack *stack, void *ud)
{
    ...
    switch(pd->mode) {
        case PLUMBER_CREATE:
            ...
            sp_oscmorph_create(&oscmorph->data);
            oscmorph->nft = 2;
            oscmorph->ft = (sp_ftbl**)malloc(sizeof(sp_ftbl *) * 2);
            oscmorph->ftname = (const char**)malloc(sizeof(char *) * 2);
