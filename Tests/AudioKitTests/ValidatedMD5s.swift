...
let validatedMD5s: [String: [String]] = [
    ...
    "-[EngineTests testBasic]": ["96f75d59420c90eefa2a9f953902f358"],
    "-[EngineTests testDynamicChange]": ["1366837b009efedbc445a4c963131b0b"],
    "-[EngineTests testEffect]": ["4a45d6a3369c9fd3d1fb91833d73252a"],
    "-[EngineTests testMixer]": ["afd041d70949e88931a8b7ad802ac36f"],
    "-[EngineTests testMixerDynamic]": ["6126c43ac5eb4c1449adf354ad7f30e3"],
    "-[EngineTests testMixerVolume]": ["e68370da71ed55059dfdebe3846bb864"],
    "-[EngineTests testMultipleChanges]": ["d0ec5cb2d162a8519179e7d9a3eed524"],
    "-[EngineTests testOscillator]": ["b484df49b662f3bc1b41be9d5e3dcd23"],
    "-[EngineTests testSampler]": ["f44518ab94a8bab9a3ef8acfe1a4d45b"],
    "-[EngineTests testSamplerMIDINote]": ["38f84463320c0824422b4105b771b67c"],
    "-[EngineTests testTwoEffects]": ["c1a6abd874e85a0c4721af2ad8f46f54"],
