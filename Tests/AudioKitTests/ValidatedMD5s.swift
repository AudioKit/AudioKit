...
let validatedMD5s: [String: [String]] = [
    ...
    "-[AudioPlayerTests testDefault]": ["a13aea9dcf485589666db760e14241d3"],
    "-[AudioPlayerTests testPitch]": ["481f7709e7a08a926112a256a5a6ced6"],
    "-[AudioPlayerTests testRate]": ["576c1def2055593cd827aa3f1d6effde"],
    ...
    "-[SamplerTests testPlayMIDINote]": ["f44518ab94a8bab9a3ef8acfe1a4d45b"],
    "-[SamplerTests testStopMIDINote]": ["8c5c55d9f59f471ca1abb53672e3ffbf"],
