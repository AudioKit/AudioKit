...
let validatedMD5s: [String: [String]] = [
    ...
    "-[EngineTests testMixerDynamic]": ["f1428ff0eaf4949f51790226c3d619dc"],
    "-[EngineTests testMixerVolume]": ["025e920c34f50da04d03c8af3e21ac82"],
    "-[EngineTests testMultipleChanges]": ["5f7d6a56abfd240629985f770f013a58"],
