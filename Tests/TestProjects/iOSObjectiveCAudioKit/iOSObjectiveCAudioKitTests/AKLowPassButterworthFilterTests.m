...
@interface AKLowPassButterworthFilterTests : XCTestCase
@end
...
- (void)testLowPassButterworthFilter
{
    ...
    // Render audio output
    NSString *outputFile = [NSString stringWithFormat:@"%@/AKTest-LowPassButterworthFilter.aiff", NSTemporaryDirectory()];
