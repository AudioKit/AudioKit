...
echo "Skipping iOS Unit Tests (for now)"
#xcodebuild -scheme AudioKitTestSuite -project AudioKit/iOS/AudioKitTestSuite/AudioKitTestSuite.xcodeproj test -sdk iphonesimulator | xcpretty -c || exit 3
