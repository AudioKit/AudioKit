...
echo "Skipping Building macOS HelloWorld"
...
echo "Skipping Building macOS MicrophoneAnalysis"
...
echo "Skipping Building macOS MidiMonitor"
...
echo "Skipping Building macOS SporthEditor"
