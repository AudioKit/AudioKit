...
xcodebuild -project AudioKit/macOS/AudioKitTestSuite/AudioKitTestSuite.xcodeproj -scheme AudioKitTestSuite test ONLY_ACTIVE_ARCH=YES CODE_SIGNING_REQUIRED=NO CODE_SIGN_IDENTITY="" clean build | xcpretty -c || exit 101
