...
xcodebuild -scheme AudioKitTestSuite -project AudioKit/iOS/AudioKitTestSuite/AudioKitTestSuite.xcodeproj test -destination 'platform=iOS Simulator,name=iPhone 5s' || exit 3
